  ...
  <vs-tabs v-model="next">
      ...
      <vs-tab label="">
       <div class="clearfix">
          ...
          <v-select class="select-province" placeholder="Chọn Tỉnh / Thành Phố" v-model="selected_type_store" :options="LIST_PROVINCE" 
          value="ID_PROVINCE"  label="NAME_PROVINCE"  ></v-select>
          <v-select class="select-district" placeholder="Chọn Quận / Huyện" v-model="selected_type_store" :options="LIST_DISTRICT" 
