  ...
  <vs-tabs v-model="next">
      ...
      <vs-tab label="">
       <div class="clearfix">
          ...
          <v-select class="select-province" placeholder="Chọn Tỉnh / Thành Phố" v-model="select_province" :options="LIST_PROVINCE" 
          value="ID_PROVINCE"  label="NAME_PROVINCE"  ></v-select>
          <v-select class="select-district" placeholder="Chọn Quận / Huyện" v-model="select_district" :options="LIST_DISTRICT" 
