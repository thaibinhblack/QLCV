      ...
      <vs-tab label="">
       <div class="clearfix">
          ...
          value="ID_DISTRICT"  label="NAME_DISTRICT"  ></v-select>
           <vs-input   v-validate="'required'" label="Địa chỉ" v-model="store.DIA_CHI_CUA_HANG" class="mt-5 w-full" name="DIA_CHI_CUA_HANG" placeholder="Nhập địa chỉ cửa hàng" v-validate="'required'" />
          ...
          <vs-input   v-validate="'required'" label="Số điện thoại" v-model="store.SDT_CUA_HANG" class="mt-5 w-full" name="SDT_CUA_HANG" placeholder="Nhập địa số điện thoại cửa hàng" v-validate="'required'" />
