...
<vs-row vs-w="12" class="form-add-product">
    ...
    <vs-col class="p-6"  vs-align="left" vs-lg="4" vs-sm="12" vs-xs="12" >
        <div class="sidebar-add-product">
            <p class="title-sidebar" @click="active_iamge = !active_image">Ảnh nổi bật sản phẩm  <vs-icon class="icon-left" :icon="active_iamge == false ? 'keyboard_arrow_down' : 'keyboard_arrow_up'"></vs-icon></p>
            <div class="card-image-product p-6" :class="active_iamge">
...
<style scoped>
.sidebar-add-product, .content-product{background: #fff;border-radius: 5px;}
