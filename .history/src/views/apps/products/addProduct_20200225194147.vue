    ...
    <vs-col class="p-6"  vs-align="left" vs-lg="4" vs-sm="12" vs-xs="12" >
        <div class="sidebar-add-product">
            ...
            <div class="card-type-product p-6">
                <vs-row vs-w="12">
                    <v-col  vs-justify="left" vs-align="left" vs-lg="4" vs-sm="12" vs-xs="12">
                        <vs-checkbox color="danger"/>
                    </v-col>
                    <v-col  vs-justify="left" vs-align="left" vs-lg="8" vs-sm="12" vs-xs="12">
                        <vs-list-item title="Snickerdoodle" subtitle="123">
                        </vs-list-item>
                    </v-col>
                </vs-row>
            </div>
