...
<vs-row vs-w="12" class="form-add-product">
    ...
    <vs-col class="p-6"  vs-align="left" vs-lg="4" vs-sm="12" vs-xs="12" >
        <div class="sidebar-add-product">
            <p class="title-sidebar">Ảnh nổi bật sản phẩm  <vs-icon class="icon-left" icon="keyboard_arrow_up"></vs-icon></p>
...
.title-sidebar {border-bottom: 1px solid #e2e2e2;margin: 12px; padding: 12px 0;}
</style>px;