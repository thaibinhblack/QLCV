    ...
    <vs-col class="p-6"  vs-align="left" vs-lg="4" vs-sm="12" vs-xs="12" >
        <div class="sidebar-add-product">
            ...
            <div class="card-sidebar card-info-product p-6">
                ...
                <vs-input v-model="product.SALE" class="full-width" type="number" min="0" max="100" label="Phần trăm khuyến mãi"></vs-input>
                <vs-input type="date" label="Ngày bắt đầu khuyến mãi"></vs-input>
            </div>
...
.vs-list--item.promotion {border-bottom: none;margin: 10px 0;}
</style>px;