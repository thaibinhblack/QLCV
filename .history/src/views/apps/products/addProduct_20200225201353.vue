...
<vs-row vs-w="12" class="form-add-product">
    ...
    <vs-col class="p-6"  vs-align="left" vs-lg="4" vs-sm="12" vs-xs="12" >
        <div class="sidebar-add-product">
            ...
            <p class="title-sidebar" @click="active_info = !active_info">Ảnh nổi bật sản phẩm  <vs-icon class="icon-left" :icon="active_info == false ? 'keyboard_arrow_down' : 'keyboard_arrow_up'"></vs-icon></p>
            <div class="card-sidebar card-info-product p-6" :class="{active: active_info}">
               ...
               <div class="card-promotion" :class="{active: product.PROMOTION}">
                    <vs-input v-model="product.SALE" class="full-width input-sidebar" type="number" min="0" max="100" label="Phần trăm khuyến mãi"></vs-input>
