    ...
    watch:
    {
        ...
        selected_type(type)
        {
          ...
          if(type != null)
          {
            ...
            this.LIST_CUSTOMER_LOCAL = this.LIST_CUSTOMER.filter((value,index,array) => {
              return array[index].ID_CUA_HANG == type.ID_CUA_HANG &&  array[index].SO_TIEN_DA_CHI >= type.SO_TIEN_PHAN_LOAI_MIN && array[index].SO_TIEN_DA_CHI < type.SO_TIEN_PHAN_LOAI_MAX
            })
          }else
          {
            this.LIST_CUSTOMER_LOCAL = this.LIST_CUSTOMER.filter((value,index,array) => {
