    ...
    <div>
        <vs-table ref="table" :data="LIST_CUSTOMER_SYSTEM_LOCAL" >
          <div style="margin-bottom: 15px;" slot="header" class="header-table-search flex flex-wrap-reverse  flex-grow ">
                ...
                <v-select class="select-phan-loai" placeholder="Chọn quận / huyện" v-model="select_district" :options="LIST_DISTRICT"  value="ID_DISTRICT"  label="NAME_DISTRICT" ></v-select>
...
export default {
    ...
    computed:
    {
        ...mapGetters([ "LIST_CUSTOMER_SYSTEM", "LIST_PROVINCE"]),
        stores:{
            get()
            {
