    ...
    <div>
      ...
      <sidebar-phan-loai />
        ...
        <vs-table ref="table" :data="LIST_CUSTOMER_LOCAL" >
          <div style="margin-bottom: 15px;" slot="header" class="header-table-search flex flex-wrap-reverse  flex-grow justify-between">
                <!-- {{stores}} -->
                ...
                <v-select class="select-phan-loai" placeholder="Nhập loại khách hàng" :options="LIST_TYPE_LOCAL"></v-select>
