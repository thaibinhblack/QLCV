  ...
  <vs-sidebar @keyup.esc="isSidebarActiveLocal = false" click-not-close position-right parent="body" default-index="1" color="primary" class="add-new-data-sidebar items-no-padding" spacer v-model="isSidebarActiveLocal">
    ...
    <VuePerfectScrollbar class="scroll-area--data-list-add-new">
        <div class="p-6">
            ...
            <vs-input class="w-full" type="text" label="Loại khách hàng" placeholder="Nhập loại khách hàng"></vs-input>
            <vs-input class="w-full mt-15" type="number" label="Số tiền thấp nhất" placeholder="Nhập số tiền nhỏ nhất"></vs-input>
            <vs-input class="w-full mt-15" type="number" label="Số tiền lớn nhất" placeholder="Nhập số tiền lớn nhất"></vs-input>
            <vs-textarea label="Ghi chú" class="mt-15 w-full" name="MO_TA_SAN_PHAM" placeholder="Nhập địa chỉ khách hàng"  />    
