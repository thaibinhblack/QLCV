      ...
      <div class="p-6">
        ...
        <template>
          ...
          <div class="img-container w-64 mx-auto flex items-center justify-center">
            <vs-avatar size="120px" src="https://avatars2.githubusercontent.com/u/31676496?s=460&v=4"/>
            <!-- <img :src="dataImg" alt="img" class="responsive"> -->
            <div class="group-action-avatar mt-5">
              <input type="file" class="hidden" ref="updateImgInput" @change="updateCurrImg" accept="image/*">
              <vs-button class="mr-4 btn-not-color" type="flat" @click="$refs.updateImgInput.click()"><vs-icon icon="cloud_upload"></vs-icon></vs-button>
