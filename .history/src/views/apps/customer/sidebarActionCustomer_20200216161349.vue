        ...
        <div class="p-6">
          ...
          <vs-row>
            ...
            <div class="mt-6" style="margin-left:15px;">
              <vs-input type="number" min="0" label="Số lượng sản phẩm" v-model="cusomter.SO_LUONG_HT" class="w-full" name="SO_LUONG_HT" placeholder="Nhập số lượng sản phẩm" v-validate="'required'" />
          ...
          <vs-textarea label="Mô tả sản phẩm" v-model="cusomter.MO_TA_SAN_PHAM" class="mt-5 w-full" name="MO_TA_SAN_PHAM" placeholder="Nhập mô tả sản phẩm"  />
