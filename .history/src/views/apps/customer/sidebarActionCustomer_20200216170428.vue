  ...
  <vs-sidebar click-not-close position-right parent="body" default-index="1" color="primary" class="add-new-data-sidebar items-no-padding" spacer v-model="isSidebarActiveLocal">
    ...
    <VuePerfectScrollbar class="scroll-area--data-list-add-new" :settings="settings">
        <div class="p-6">
          ...
          <v-select v-model="cusomter.DC_TP_KH" :options="LIST_PROVINCE" :reduce="province => province.ID_PROVINCE" label="NAME_PROVINCE" @change="FilterProvince()" />
          <p class="text-sm" style="margin-top: 15px;">QUẬN / HUYỆN</p>
          <v-select v-model="cusomter.DC_TP_KH" :options="LIST_DISTRICT" :reduce="province => district.ID_DISTRICT" label="NAME_DISTRICT" />
        </div>
    </VuePerfectScrollbar>
