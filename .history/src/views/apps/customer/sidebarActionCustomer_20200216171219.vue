  ...
  <vs-sidebar click-not-close position-right parent="body" default-index="1" color="primary" class="add-new-data-sidebar items-no-padding" spacer v-model="isSidebarActiveLocal">
    ...
    <VuePerfectScrollbar class="scroll-area--data-list-add-new" :settings="settings">
        <div class="p-6">
          ...
          <v-select v-model="cusomter.DC_QH_KH" :options="LIST_DISTRICT" :reduce="district => district.ID_DISTRICT" label="NAME_DISTRICT" />
        <vs-textarea label="Địa chỉ" v-model="cusomter.DC_NHA_KH" class="mt-5 w-full" name="MO_TA_SAN_PHAM" placeholder="Nhập địa chỉ khách hàng"  />    
        </div>
    </VuePerfectScrollbar>
...
export default {
  ...
  methods: {
    ...
    FilterProvince()
    {
        this.$store.dispatch('fetchDistrict',this.cusomter.DC_TP_KH)
    }
  },
  created()
  {
