    ...
    <div class="setting-store page-setting p-0">
        <vs-row vs-w="12" v-for="(setting,index) in settings" :key="index">
            <vs-col class="p-1" vs-type="flex" vs-justify="center" vs-align="center" vs-lg="3" vs-sm="3" vs-xs="3" >
                <vs-input label="TÊN BIẾN THUỘC TÍNH" v-model="setting.NAME_ATTRIBUTE" class="mt-5 w-full" name="TEN_CUA_HANG" placeholder="Nhập tên thuộc tính" v-validate="'required'" />
            </vs-col>
            <vs-col class="p-1" vs-type="flex" vs-justify="center" vs-align="center" vs-lg="4" vs-sm="4" vs-xs="4">
                <vs-input label="TÊN THUỘC TÍNH" v-model="setting.NOTE_ATTRIBUTE"  class="mt-5 w-full" name="TEN_CUA_HANG" placeholder="Nhập tên thuộc tính" v-validate="'required'" />
            </vs-col>
            <vs-col class="p-1" vs-type="flex" vs-justify="center" vs-align="center" vs-lg="3" vs-sm="3" vs-xs="3">
