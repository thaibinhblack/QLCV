  ...
  <vs-sidebar click-not-close position-right parent="body" default-index="1" color="primary" class="add-new-data-sidebar items-no-padding" spacer v-model="isSidebarActiveLocal">
    ...
    <VuePerfectScrollbar class="scroll-area--data-list-add-new" :settings="settings">
       <div class="p-6">
          ...
          <!-- {{selected_province}} {{LIST_PROVINCE}} -->
          <v-select class="select-store m15" placeholder="Tỉnh / Thành phố"  v-model="selected_province">
            <vs-select-item :key="item.ID_PROVINCE" :value="item.ID_PROVINCE" :text="item.NAME_PROVINCE" v-for="item in LIST_PROVINCE" />
          </v-select>
