    ...
    <vs-table ref="table" pagination :max-items="itemsPerPage" search :data="stores">
      ...
      <div slot="header" class="flex flex-wrap-reverse items-center flex-grow justify-between">
        ...
        <template slot="thead">
          ...
          <vs-th>Tên loại cửa hàng</vs-th>
          <vs-th>Tỉnh / Thành Phố</vs-th>
          ...
          <tbody>
            <vs-tr :data="tr" :key="indextr" v-for="(tr, indextr) in data">
              ...
              <vs-td>
               ...
               <vs-td>
                <p class="product-name font-medium truncate">{{ tr.TEN_LOAI_CUA_HANG }}</p>
              </vs-td>
            
              <vs-td>{{tr.NAME_PROVINCE}}</vs-td>

              <vs-td>{{tr.NAME_DISTRICT}}</vs-td>
              ...
              <vs-td class="whitespace-no-wrap">
                ...
                <vs-button class="btn-not-color" @click="editManager(tr)" size="small"> <vs-icon icon="group"></vs-icon></vs-button>
              </vs-td>
...
export default {
  ...
  methods: {
    ...
    RENDER_VALUE_OPTION(data,index,option)
    {
     
      console.log('test',index,data, data[index])
      if(data[index])
      {
        
        if(data[index].VALUE_ATTRIBUTE)
        {
          if(option.NAME_ATTRIBUTE == data[index].NAME_ATTRIBUTE)
          {
            return data[index].VALUE_ATTRIBUTE;
          }
          else
          {
            return ""
