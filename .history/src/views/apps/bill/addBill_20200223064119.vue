...
<vs-row vs-w="12">
  ...
  <vs-col vs-justify="left" vs-align="left" vs-lg="9" vs-sm="12" vs-xs="12" >
  ...
  <vs-col vs-justify="center" vs-align="center" vs-lg="3" vs-sm="12" vs-xs="12" v-if="Object.entries(selected_customer).length > 0">
    <vs-input label="Tên khách hàng" v-model="selected_customer.TEN_KH" class="mt-5 w-full" name="TEN_CUA_HANG" placeholder="Nhập tên cửa hàng" v-validate="'required'" />
...
.list-product>li{display: inline-block; width: 25%;}
</style>