  ...
  <vs-col class="p-6" vs-justify="center" vs-align="center" vs-lg="5" vs-sm="12" vs-xs="12" >
    <div class="section-bill bg-white p-6">
      ...
      <div class="selected_customer" v-if="selected_customer != null">
          ...
          <ul class="list-point">
            <li>
              <button class="w-full">Đổi điểm / giảm giá   <vs-icon class="icon-right" icon="keyboard_arrow_down"></vs-icon></button>
              <ul class="list-child">
...
.list-point>li {cursor: pointer;padding: 10px 5px;}
.list-point>li>ul>li {padding: 10ox 0;}
.list-point>li>button {background: transparent;border: none;outline: none;text-align: left}
</style>