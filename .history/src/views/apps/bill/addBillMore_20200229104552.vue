  ...
  <vs-col class="p-6" vs-justify="left" vs-align="left" vs-lg="7" vs-sm="12" vs-xs="12" >
   <div class="section-product p-6">
       <vs-button>Thêm mới sản phẩm</vs-button>
        <vs-row vs-w="12">
              <vs-col vs-justify="left" vs-align="left" vs-lg="7" vs-sm="12" vs-xs="12" >
                    <vs-input type="text"></vs-input>
              </vs-col>
               <vs-col vs-justify="left" vs-align="left" vs-lg="4" vs-sm="12" vs-xs="12" >
                    <vs-input type="number"></vs-input>
              </vs-col>
        </vs-row>
   </div>
