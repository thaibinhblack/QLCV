...
<vs-row vs-w="12">
  ...
  <vs-col class="p-6" vs-justify="left" vs-align="left" vs-lg="7" vs-sm="12" vs-xs="12" >
   <div class="section-product p-6">
      <span v-if="LIST_PRODUCT.length == 0">Chưa chọn cửa hàng!</span>
      <item
  <vs-col class="p-6" vs-justify="left" vs-align="left" vs-lg="7" vs-sm="12" vs-xs="12" >
   <div class="section-product p-6">
       <vs-button @click="addProduct()">Thêm mới sản phẩm</vs-button>
        <vs-row vs-w="12" v-for="(store,index) in selected_store" :key="index">
                <vs-col vs-justify="left" vs-align="left" vs-lg="7" vs-sm="7" vs-xs="7" >
                    <vs-input v-model="store.TEN_SAN_PHAM"  class="mt-5 mr-5 w-full" type="text"></vs-input>
                </vs-col>
                <vs-col vs-justify="left" vs-align="left" vs-lg="4" vs-sm="4" vs-xs="4" >
                    <vs-input v-model="store.GIA_SAN_PHAM"  class="mt-5 mr-5 w-full" type="number"></vs-input>
                </vs-col>
  ...
  <vs-col class="p-6" vs-justify="center" vs-align="center" vs-lg="5" vs-sm="12" vs-xs="12" >
    ...
    <div class="section-bill bg-white p-6">
      ...
      <div class="selected_customer" >
           <vs-input label="Tên khách hàng"  v-model="selected_customer.TEN_KH" class="mt-5 w-full" name="TEN_KH" placeholder="Nhập tên cửa hàng" v-validate="'required'" />
          <vs-input label="Số điện thoại"  v-model="selected_customer.SDT_KH" class="mt-5 w-full" name="SDT_KH" placeholder="Nhập tên cửa hàng" v-validate="'required'" />
          <vs-input label="Điểm tích lũy"  v-model="selected_customer.DIEM_TICH_LUY" class="mt-5 w-full" name="DIEM_TICH_LUY" />
...
export default {
  ...
  methods:
  {
    ...
    removeProduct(index)
    {
        this.selected_store.splice(index,1)
    },
    createBill()
    {
