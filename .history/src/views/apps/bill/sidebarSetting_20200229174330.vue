<template>
  <vs-sidebar @keyup.esc="isSidebarActiveLocal = false" click-not-close position-right parent="body" default-index="1" color="primary" class="add-new-data-sidebar items-no-padding" spacer v-model="isSidebarActiveLocal">
    ...
    <VuePerfectScrollbar class="scroll-area--data-list-add-new" >
        ...
        <vs-input type="number" class="w-full p-5" label="Cài đặt số tiền hóa đơn"></vs-input>
        <vs-input class="p-5 w-full" type="number" label="Cài đặt điểm"></vs-input>
        <p class="p-5">
          *Lưu ý: Dựa vào số tiền hóa đơn để đổi thành điểm <br/>
          - Ví dụ: 100,000 vnđ = 1 điểm thì hóa đơn khi 150,000 vnđ sẽ là 1 điểm  <br/>
          - Điểm tích lũy cũ của khách hàng sẽ không thay đổi nếu cập nhật lại, điểm lích lũy các hóa đơn từ các lành thanh toán sau sẽ thay đổi.
        </p>
    </VuePerfectScrollbar>
    <div class="flex flex-wrap items-center p-6" slot="footer">
      <vs-button type="border" color="primary" style="margin-right: 5px;">Cập nhật</vs-button>
