...
<vs-row vs-w="12">
  ...
  <vs-col vs-justify="center" vs-align="center" vs-lg="4" vs-sm="12" vs-xs="12" v-if="selected_customer != null">
    <vs-input label="Tên khách hàng" disabled v-model="selected_customer.TEN_KH" class="mt-5 w-full" name="TEN_CUA_HANG" placeholder="Nhập tên cửa hàng" v-validate="'required'" />
