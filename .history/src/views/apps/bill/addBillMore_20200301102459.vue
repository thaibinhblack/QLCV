  ...
  <vs-col class="p-6" vs-justify="center" vs-align="center" vs-lg="5" vs-sm="12" vs-xs="12" >
    <div class="section-bill bg-white p-6">
      ...
      <div class="selected_customer" v-if="selected_customer != null">
          ...
          <ul class="total">
              <li><small>{{SETTING_POINT.SO_TIEN == 0 ? 'Chưa có cài đặt điểm tích lũy!' : (SETTING_POINT.SO_TIEN).toString().replace(/(\d)(?=(\d{3})+(?!\d))/g, '$1,')}} VNĐ =  {{SETTING_POINT.SO_TIEN == 0 ? '' : SETTING_POINT.SO_DIEM}}</small></li>
              <li>Tích lũy điểm </li>
