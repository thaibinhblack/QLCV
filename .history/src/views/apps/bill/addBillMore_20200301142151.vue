      ...
      <div class="selected_customer" v-if="selected_customer != null">
          ...
          <ul class="total">
              ...
              <li class="right"> 
                ...
                <span class="money" style="margin-left: 5px;" v-if="more.GIAM_GIA > 0 || more.DOI_DIEM > 0">{{((TOTAL_BILL - ((TOTAL_BILL/100)*more.GIAM_GIA) - (more.DOI_DIEM * SETTING_POINT.DOI_TIEN) ).toFixed(2)).toString().replace(/(\d)(?=(\d{3})+(?!\d))/g, '$1,')}} vnđ</span>  
              </li>
          </ul>
